...
<html lang="pt_br">
  ...
  ?>  
    ...
    <?php } ?> 
        ...
        <h5 style="color: red;"><span class="glyphicon glyphicon-exclamation-sign"></span> Usuário ou Senha incorretos!</h5>
        <label for="inputText" class="sr-only"  style="color: red;">Usuário</label>
