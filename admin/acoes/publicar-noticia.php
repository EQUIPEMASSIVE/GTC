...
if (isset($_POST["salvar-rascunho"])) {
    ...
    mysql_query("INSERT INTO  noticias (id_noticia, titulo, conteudo, datapub, autorPub, id_autor, tags, categoria, imagem, status) 
                VALUES (0, '$titulo', '$conteudo', '$dataPub', '$autorN', '$idAutor', '$tagsSear', $categoria, '".$imagem['name']."', 0)")or die(mysql_error());
    ...
    header ("Location: ../compor-noticia.php");
}
if (isset($_POST["publicar"])) {

    mysql_query("INSERT INTO  noticias (id_noticia, titulo, conteudo, datapub, autorPub, id_autor, tags, categoria, imagem, status) 
                VALUES (0, '$titulo', '$conteudo', '$dataPub', '$autorN', '$idAutor', '$tagsSear', $categoria, '".$imagem['name']."', 1)")or die(mysql_error());
