            ...
            <div class="content">
                <div class="page-title">
                    <div class="form-inline">
                        <h3>Rascunho das Notícias</h3></span>
                    </div>
                </div>
                <div id="publicar-noticia-extra">
                    ...
                    if (! isset ( $_GET ["id_nt_ed"] )) {
                        ...
                        <form
                                action="acoes/atualizar-noticia-rascunho.php?id_nt_up=<?php echo $id_nt; ?>"
                                ...
                                while($TND = mysql_fetch_array($SQL_TDN)){
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            ...
                                            ?></td>
                                        <td><a  id="rascunhos-menu" href="rascunho-noticia.php?id_nt_ed=<?php echo $id_nt_ed; ?>"><i class="fa fa-pencil"></i></a></td>
