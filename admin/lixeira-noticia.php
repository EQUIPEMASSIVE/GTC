            ...
            <div class="content">
                ...
                <div id="publicar-noticia-extra">
                    ...
                    if (! isset ( $_GET ["id_nt_ed"] )) {
                        ...
                        <form
                                action="acoes/atualizar-noticia-lixeira-noticia.php?id_nt_up=<?php echo $id_nt; ?>"
                                ...
                                while ( $TND = mysql_fetch_array ( $SQL_TDN ) ) {
                                    ...
                                    <tr class="">
                                        ...
                                        <td><?php
                                            ...
                                            ?></td>
                                        <td><a id="lixeira-menu" href="lixeira-noticia.php?id_nt_ed=<?php echo $TND["id_noticia"]; ?>"><i class="fa fa-pencil"></i></a></td>
                                        <td><a class="btn-sm btn-danger-dark" href="acoes/btn-lixeira-lixeira-noticia.php?idN=<?php echo $TND["id_noticia"]; ?>"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                <?php } ?>
