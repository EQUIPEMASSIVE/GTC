...
?>
                ...
                <div class="col-md-6">
                <!--Card-->
                <div class="card-block" style="min-height: 380px; max-width: auto; background-color: white; padding-bottom: 10px;">
                ...
                <span class="btn btn-outline-sucess btn-sm waves-effect" style="color: #C0C0C0" > &nbsp<i class="fa fa-clock-o" ></i>  Publicado dia: <?php echo $pusha['datapub'];?></span>
