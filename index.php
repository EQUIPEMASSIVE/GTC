...
?>
                ...
                <div class="col-md-6">
                <!--Card-->
                <div class="card wow fadeIn"  data-wow-delay="0.3s" style="background-color: white;  padding-bottom: 30px;">
                    ...
                    <div class="card collection-card">
                        ...
                        <div><!--codigo para por nome da categoria em cima da imagem da noticia-->
                            ...
                            <div  style="position: absolute; top: -20px; left: 15px;"><!--texto categoria da noticia por id-->
                              <h1 style="font-size: 20px; text-align: left; text-shadow: 3px 3px 4px rgba(0,0,0,.7); background-color: rgba(10,23,55,1.5); padding: 2px;"> 
