                ...
                <div class="card wow fadeIn"  data-wow-delay="0.3s" style="background-color: white;  padding-bottom: 10px;">
                    ...
                    <div class="card collection-card">
                        ...
                        <div><!--codigo para por nome da categoria em cima da imagem da noticia-->
                             <a href="noticia.php?id=<?php echo $pusha['id_noticia']; ?>" ><img src="cp/imagens/imgnoticia/<?php echo $pusha['imagem']; ?>" class="rounded mx-auto d-block" style="max-height: 120px;" alt="Postagem 1"/>
