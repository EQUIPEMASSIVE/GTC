        ...
        <div class="container">
            ...
            <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0px;">
                <div class="container">
                    ...
                    <input style="margin-top: 8px; padding-left: 5px;  border-radius: 20px; " class="form-control pull-right" type="text" placeholder="  Buscar..." name="busca-organica" id="inputError"  onmouseover="this.style.border='solid 2px greenyellow'" onmouseout="this.style.border='solid 2px white'>
